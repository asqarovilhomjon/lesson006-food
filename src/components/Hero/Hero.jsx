        ...
        <div className="container__person">
            <div className='grid grid-cols-2 gap-[9px]'>
                <div className='flex flex-col justify-center gap-[50px]'>
                    ...
                    <p className='font-medium text-[#150C01] opacity-70'>There are many things are needed to start the Fast Food Business. You need not only Just Food Stalls with Persons but also specialized equipment,</p>
