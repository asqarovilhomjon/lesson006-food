      ...
      <div className="container__person">
        <div className="grid grid-cols-2 gap-[97px]">
          ...
          <div className="flex flex-col justify-center items-start gap-[30px]" data-aos="flip-right">
            ...
            <p className="text-[#150C01] opacity-70 max-w-485">
              There are many things are needed to start the Fast Food Business.
              You need not only Just Food Stalls with Persons but also equipment
              make your marketing plane Effective.
            </p>
            <button className="rounded-md py-[12px] px-[25px] bg-[#DC780B] text-white border border-[#DC780B] duration-500 hover:bg-[#efab62] hover:scale-[1.02] active:scale-[.95]">Read More</button>
          </div>
        </div>
      </div>
    </section>
